...
function getWeather(cityName){
    ...
    var cityIconUrl1 = "http://openweathermap.org/img/w/" + icon1 + ".png";
    $("#icon1").attr("src", cityIconUrl1);
    var icon2 = response3.list[1].weather[0].icon;
    var cityIconUrl2 = "http://openweathermap.org/img/w/" + icon2 + ".png";
    $("#icon2").attr("src", cityIconUrl2);
    var icon3 = response3.list[2].weather[0].icon;
    var cityIconUrl3 = "http://openweathermap.org/img/w/" + icon3 + ".png";
    $("#icon3").attr("src", cityIconUrl3);
    var icon4 = response3.list[3].weather[0].icon;
    var cityIconUrl4 = "http://openweathermap.org/img/w/" + icon4 + ".png";
    $("#icon4").attr("src", cityIconUrl4);
    var icon5 = response3.list[4].weather[0].icon;
    var cityIconUrl5 = "http://openweathermap.org/img/w/" + icon5 + ".png";
    ...
    $("#humidity1").text("Humidity: " + response3.list[0].main.humidity + "%");
    $("#humidity2").text("Humidity: " + response3.list[1].main.humidity + "%");
